...
const ChatInput: React.FC<ChatInputProps> = ({ onSendMessage }) => {
  ...
  const handleImageUpload = (e: React.ChangeEvent<HTMLInputElement>) => {
    if (e.target.files && e.target.files[0]) {
      ...
      const mockUploadUrl = 'https://images.pexels.com/photos/3762453/pexels-photo-3762453.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=1';
    ...
    <div className={`p-4 border-t ${theme === 'dark' ? 'border-gray-700 bg-gray-800' : 'border-gray-200 bg-white'}`}>
      {uploadedImage && (
        <div className="relative mb-2 inline-block">
          <img src={uploadedImage} alt="Upload preview" className="h-16 w-16 object-cover rounded-md" />
          <button 
            onClick={clearImage}
      ...
      <div className="flex items-center gap-2">
        ...
        {message.trim() || uploadedImage ? (
          ...
          <button 
            ...
            aria-label={isRecording ? 'Recording...' : 'Start voice message'}
